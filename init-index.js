...
// ========== БЛОК 2: FAQ Toggle + Main Functions (з рядків 936-2857) ==========
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mobile header wallet button (top center, visible on mobile)
            const mobileHeaderWalletBtn = document.getElementById('mobileHeaderWalletBtn');
            if (mobileHeaderWalletBtn) {
                mobileHeaderWalletBtn.addEventListener('click', function(e) {
                    e.preventDefault();
                    console.log('💼 Mobile header wallet button CLICKED');
                    openWalletModal();
                });
                
                mobileHeaderWalletBtn.addEventListener('touchstart', function(e) {
                    e.preventDefault();
                    console.log('👆 Mobile header wallet button TOUCHED');
                    openWalletModal();
                }, { passive: false });
                
                console.log('✅ Mobile header wallet button listeners attached');
            }
