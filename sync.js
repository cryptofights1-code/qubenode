...
async function updateValidatorCore() {
  ...
  // Конвертуємо в TICS: ділимо на 1_000_000
  // 10709816553980156 / 1000000 = 10709816553.980156 TICS
  const tics = uTokens / 1_000_000;
  
  // Показуємо в МІЛЬЙОНАХ: 10709816553 / 1000000 = 10709.816553
  // Округляємо до цілого: 10709
  ...
  if (powerEl) {
    ...
    console.log('🔢 Delegated:', formatted, '| Raw uTICS:', uTokens, '| TICS:', tics.toFixed(2), '| Millions:', millions);
  }
}
