...
async function updateValidatorCore() {
  ...
  // Приклад: "10709090032307616" uTICS
  const uTokens = parseFloat(v.tokens);
  
  // Конвертуємо в TICS: ділимо на 1_000_000
  // 10709090032307616 / 1000000 = 10709090032.307616 TICS
  const tics = uTokens / 1_000_000;
  
  // Показуємо в тисячах: 10709090032 / 1000 = 10709090.032
  // Округляємо до цілого: 10709090
  const thousands = Math.floor(tics / 1000);
  ...
  if (powerEl) {
    ...
    console.log('🔢 Delegated:', formatted, '| Raw uTICS:', uTokens, '| TICS:', tics.toFixed(2), '| Thousands:', thousands);
  }
}
