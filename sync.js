...
function initBlockAnimation() {
  ...
  if (isMobile) {
    ...
    blocksCount = 35; // Оптимальна кількість для iPhone SE та подібних
