...
async function updateBlockHeight() {
  ...
  // Пробуємо різні endpoints для отримання актуального блоку
  const endpoints = [
  ...
  // Якщо всі endpoints не спрацювали
