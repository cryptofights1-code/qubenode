...
async function updateValidatorCore() {
  ...
  if (powerEl) {
    ...
    // ВРУЧНУ форматуємо: 10709090 -> "10,709 M"
    let formatted;
    if (tokens >= 1_000_000) {
      // Ділимо на 1000: 10709090 / 1000 = 10709
      const thousands = Math.floor(tokens / 1000);
      
      // ВРУЧНУ додаємо коми: 10709 -> "10,709"
      ...
      const thousands = Math.floor(tokens / 1000);
      formatted = thousands.toString() + " K";
    } else {
    ...
    console.log('✅ FINAL Amount:', formatted, '| Raw:', tokens);
  }
}
