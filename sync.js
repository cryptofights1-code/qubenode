// === QubeNode Live Sync Script v2.7 ===
// Includes: validator info, delegators, inflation, uptime, block time, validator rank, TICS price from MEXC
// New: Validator Rank replaces Signed Blocks, APY moved to second row
// Fixed: Removed duplicate VALCONS_ADDR declaration, Added CORS proxy for MEXC
...
async function updateValidatorRank() {
  ...
  try {
    ...
    if (rank > 0) {
      ...
      console.log(`✅ Validator rank: #${rank} out of ${total}`);
    } else {
      el.textContent = "--";
