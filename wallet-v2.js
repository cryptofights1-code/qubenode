// === QubeNode Wallet Integration v2.1.4 ===
...
console.log('🔐 QubeNode Wallet Integration v2.1.4 LOADED - FULL DEBUG MODE');
...
async function connectWalletType(type) {
  ...
  try {
    ...
    // CRITICAL DEBUG: Show what address we got
    alert(`🔍 DEBUG:\n\nKeplr повернув адресу:\n${key.bech32Address}\n\nІм'я акаунту: ${key.name}\n\nЦе та адреса яку ти очікував?`);
